...
import com.myblogrestapi.entity.CommentService;
...
import com.myblogrestapi.payload.ModelMapper;
...
//        commentDto.setBody(comment.getBody());
    ...
    private CommentDto mapToEntity(Comment commentDto){
        CommentDto comment = mapper.map(commentDto, Comment.class);
